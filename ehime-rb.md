...
![Discordアプリ左側のサーバー一覧の最下部にある「+」（サーバーを追加）アイコン](/images/Screenshot_20220928_151857.png)

「サーバーに参加」を選択して

![「サーバーを作成」ダイアログの最下部にある「サーバーに参加」ボタン](/images/Screenshot_20220928_151952.png)

「招待リンク」のところに上記のリンクのURLを入力すると確実です。

![「サーバーに参加」ダイアログの招待リンク入力欄](/images/Screenshot_20220928_152031.png)
